...
3.3) "G" : convert display to green colors
3.4) "C" : convert display to RGB colors
3.5) "O" : display only (full screen) the video which plays sound
3.6) "M" : display two videos
3.7) "X" : save a snapshot in folder
3.8) "1" : play sound of the first video
3.9) "2" : play sound of the second video
